...
![DataXReaderWriter (2)](https://code.gaf.net.cn/nrap/datax/datax-dev/tree/master/images/plugin_dev_guide_1.png)

上图中，黄色表示`Job`部分的执行阶段，蓝色表示`Task`部分的执行阶段，绿色表示框架执行阶段。

相关类关系如下：

![DataX](https://code.gaf.net.cn/nrap/datax/datax-dev/tree/master/images/plugin_dev_guide_2.png)
...
![Columns](https://code.gaf.net.cn/nrap/datax/datax-dev/tree/master/images/plugin_dev_guide_3.png)
