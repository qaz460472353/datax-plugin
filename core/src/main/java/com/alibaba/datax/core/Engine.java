...
public class Engine {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
        	//设置运行的datax的家目录
       // System.setProperty("datax.home", "D:\\1-workCode\\superMap\\IDEA\\SJTB\\datax-dev\\target\\datax\\datax");
            //设置datax的运行脚本信息
            // args = new String[]{"-mode", "standalone", "-jobid", "-1", "-job", "C:\\Users\\Administrator\\Desktop\\temp.json"};
            Engine.entry(args);
        } catch (Throwable e) {
            exitCode = 1;
