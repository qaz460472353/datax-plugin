...
public final class Key {
    ...
    public static boolean getIsUpdate(Configuration conf) {
        return conf.getBool("isUpdate", false);
    }

    public static String getTargetType(Configuration conf) {
        return conf.getString("targetType", "");
    }
    public static String getTargetIndex(Configuration conf) {
        return conf.getString("targetIndex", "");
    }

    public static String getTargetField(Configuration conf) {
        return conf.getString("targetField", "");
    }
}
